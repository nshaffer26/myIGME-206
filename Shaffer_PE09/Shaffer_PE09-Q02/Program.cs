...
class Program
{
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            while (!outOfTime)
            {
                // Set the timer equal to 5 seconds (5000 milliseconds)
                timer = new System.Timers.Timer(5000);

                // When the timer elapses, call the TimesUp method
                ...
                do
                {
                    Console.Write("You have 5 seconds:\n" + sQuestions);
            ...
            // Start a new question, no longer out of time
            outOfTime = false;
        }
